...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertitem() {
        ...
        // and Laptop's item attributes are the values.
        ContentValues values = new ContentValues();
        values.put(ItemEntry.COLUMN_PRODUCT_NAME, "Laptop");
        values.put(ItemEntry.COLUMN_CURRENT_QUANTITY, 50);
        values.put(ItemEntry.COLUMN_ITEM_PRICE, 5068);
        values.put(ItemEntry.COLUMN_PICTURE,"no image");

        // Insert a new row for Laptop into the provider using the ContentResolver.
        // Use the ItemEntry to indicate that we want to insert
